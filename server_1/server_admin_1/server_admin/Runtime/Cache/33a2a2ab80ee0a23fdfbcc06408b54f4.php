...
<div class="btn-toolbar" style="margin-bottom:2px;">
    <a href="__URL__/add" class="btn btn-primary"><i class="icon-plus"></i> 添加内容</a>
...
<!-- search END -->
    <div class="block">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">内容列表</a>
        <div id="page-stats" class="block-body collapse in">
              ...
              <td>
				...
				&nbsp;&nbsp;
				<a href="__URL__/edit/id/<?php echo ($result_list["id"]); ?>" title= "修改" ><i class="icon-pencil"></i></a>
				&nbsp;&nbsp;
