...
<div class="btn-toolbar" style="margin-bottom:2px;">
    <a href="__APP__/Account/add" class="btn btn-primary"><i class="icon-plus"></i> 添加账号</a>
</div>
    <div class="block">
        ...
        <div id="page-stats" class="block-body collapse in">
              ...
              <tbody>	
              <?php if(is_array($accounts)): foreach($accounts as $key=>$account): ?><tr>
				<td><?php echo ($account["account_name"]); ?></td>
				<td><?php echo ($account["add_time"]); ?></td>
				<td><?php echo ($account["last_login_time"]); ?></td>
				<td><?php echo ($account["last_login_ip"]); ?></td>
				<td>
				<a href="__APP__/Account/edit/id/<?php echo ($account["account_id"]); ?>" title= "修改" ><i class="icon-pencil"></i></a>
				&nbsp;&nbsp;
				<a data-toggle="modal" href="#myModal" title= "删除" ><i class="icon-remove" href="__APP__/Account/del/id/<?php echo ($account["account_id"]); ?>" ></i></a>
				</td>
