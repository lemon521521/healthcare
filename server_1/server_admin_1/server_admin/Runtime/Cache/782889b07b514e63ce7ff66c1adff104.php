...
<div id="content" class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">新增医师</h1>
        </div>
        
		<ul class="breadcrumb">
						<li><a href="__URL__/index"> 医师列表 </a> <span class="divider">/</span></li>
			<li class="active">新增医师</li>
        </ul>
...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab">请填写医师信息</a></li>
    </ul>	
	...
	<div id="myTabContent" class="tab-content">
		  <div class="tab-pane active in" id="home">
           ...
           <form id="tab" method="post" action="__URL__/add" autocomplete="off">				
				<label>医师名</label>
				<input type="text" name="physician_name" value="" class="input-xlarge" autofocus="true" required="true" >
				
				<label>简介</label>				
					<textarea  name="introduction" style="width:500px;height:300px;" class="input-xlarge" autofocus="true" required="true">
			
				</textarea>
				<label>医师照片</label>
				<input type="hidden"  id="url3" name="img_url" value="" /><div id="J_imageView"></div> <input type="button" id="image3" value="选择图片" />
