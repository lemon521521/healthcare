	...
	<div id="myTabContent" class="tab-content">
		  <div class="tab-pane active in" id="home">
           ...
           <form method="post" action="__URL__/add" id="tab"  autocomplete="off">
			...
			<!-- 	<select name='chrsubpid' id="chrsubpid">
				<option value=0>请选择三级栏目</option>
				</select> -->
				<label>产品名</label>				
				...
				<label>VIP电话</label>				
				<input type="text" name="vip_tel" value="" class="input-xlarge" autofocus="true" required="true" >
				<label>行程天数 </label>				
				...
				<input name="content2" type="hidden" id="content2" value=""/>
				<label>相关须知</label>
