...
<div class="btn-toolbar" style="margin-bottom:2px;">
    <a href="__URL__/add" class="btn btn-primary"><i class="icon-plus"></i> 添加栏目</a>
</div>
    <div class="block">
        ...
        <div id="page-stats" class="block-body collapse in">
              ...
              <thead>
                <tr>
					<th style="width:80px">栏目名</th>
					<th style="width:80px">操作</th>
                </tr>
              </thead>
              <tbody>	
              <?php if(is_array($menu)): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
              	<td><?php $__FOR_START__=2;$__FOR_END__=$menu['count'];for($i=$__FOR_START__;$i < $__FOR_END__;$i+=1){ ?>&nbsp;-<?php } echo ($menu["name"]); ?></td>
              <td>
				<a href="__URL__/edit/id/<?php echo ($menu["id"]); ?>" title= "修改" ><i class="icon-pencil"></i></a>
				&nbsp;&nbsp;
				<a data-toggle="modal" href="#myModal" title= "删除" ><i class="icon-remove" href="__URL__/del/id/<?php echo ($menu["id"]); ?>" ></i></a>
			</td>	
