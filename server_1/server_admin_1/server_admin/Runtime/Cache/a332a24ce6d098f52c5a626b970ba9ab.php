...
<div id="sidebar-nav" class="sidebar-nav">
 ...
 <div id="content" class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">医师列表</h1>
        </div>
        
		<ul class="breadcrumb">
			<li class="active">医师列表</li>
        </ul>
...
<div class="btn-toolbar" style="margin-bottom:2px;">
    <a href="__URL__/add" class="btn btn-primary"><i class="icon-plus"></i> 添加医师</a>
</div>
    <div class="block">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">医师列表</a>
        <div id="page-stats" class="block-body collapse in">
               <table class="table table-striped">
              <thead>
                <tr>
					<th style="width:80px">医师名</th>					
              ...
              <tbody>	
              <?php if(is_array($Physicianlist)): $i = 0; $__LIST__ = $Physicianlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Physicianlist): $mod = ($i % 2 );++$i;?><tr>
              	<td><?php echo ($Physicianlist["physician_name"]); ?></td>
              	<td><?php echo ($Physicianlist["introduction"]); ?></td>             	            
              	<td><?php echo (date('Y-m-d H:i:s',$Physicianlist["insert_time"])); ?></td>
              	<td><?php echo (date('Y-m-d H:i:s',$Physicianlist["update_time"])); ?></td>              	
              <td>
				<a href="__URL__/edit/id/<?php echo ($Physicianlist["id"]); ?>" title= "修改" ><i class="icon-pencil"></i></a>
				&nbsp;&nbsp;
				<a data-toggle="modal" href="#myModal" title= "删除" ><i class="icon-remove" href="__URL__/del/id/<?php echo ($Physicianlist["id"]); ?>" ></i></a>
			</td>	
