...
<div id="sidebar-nav" class="sidebar-nav">
 ...
 <div id="content" class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title"><?php echo ($pinfo["title"]); ?>（费用列表）</h1>
        </div>
...
<div class="btn-toolbar" style="margin-bottom:2px;">
    <a href="__URL__/add/id/<?php echo ($pinfo["id"]); ?>" class="btn btn-primary"><i class="icon-plus"></i> 添加费用</a>
</div>
    <div class="block">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">费用列表</a>
        <div id="page-stats" class="block-body collapse in">
               <table class="table table-striped">
              <thead>
                <tr>
               		<th style="width:80px">费用名称</th>
              ...
              <tbody>	
              <?php if(is_array($cost_list)): $i = 0; $__LIST__ = $cost_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cost_list): $mod = ($i % 2 );++$i;?><tr>
              <td><?php echo ($cost_list["cost_name"]); ?></td>
              	<td><?php echo (date('Y-m-d H:i:s',$cost_list["createtime"])); ?></td>
              	<td><?php echo (date('Y-m-d H:i:s',$cost_list["updatetime"])); ?></td>              	
              <td>
				<a href="__URL__/edit/id/<?php echo ($cost_list["id"]); ?>" title= "修改" ><i class="icon-pencil"></i></a>
				&nbsp;&nbsp;
				<a data-toggle="modal" href="#" title= "删除" ><i class="icon-remove" href="__URL__/del/id/<?php echo ($cost_list["id"]); ?>"></i></a>
			</td>	
