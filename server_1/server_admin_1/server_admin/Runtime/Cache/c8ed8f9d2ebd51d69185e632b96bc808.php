...
<div class="btn-toolbar" style="margin-bottom:2px;">
    <a href="__URL__/add" class="btn btn-primary"><i class="icon-plus"></i> 添加国家</a>
</div>
    <div class="block">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">国家列表</a>
        <div id="page-stats" class="block-body collapse in">
               <table class="table table-striped">
              <thead>
                <tr>
					<th style="width:80px">国家名</th>
					<th style="width:80px">国家名（英文</th>
					<th style="width:80px">优先级</th>
					<th style="width:80px">操作</th>
                </tr>
              </thead>
              <tbody>	
              <?php if(is_array($Arealist)): $i = 0; $__LIST__ = $Arealist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Arealist): $mod = ($i % 2 );++$i;?><tr>
              	<td><?php echo ($Arealist["name"]); ?></td>
              	<td><?php echo ($Arealist["en_name"]); ?></td>
              	<td><?php echo ($Arealist["order_sort"]); ?></td>
              <td>
				<a href="__URL__/edit/id/<?php echo ($Arealist["id"]); ?>" title= "修改" ><i class="icon-pencil"></i></a>
				&nbsp;&nbsp;
				<a data-toggle="modal" href="#myModal" title= "删除" ><i class="icon-remove" href="__URL__/del/id/<?php echo ($Arealist["id"]); ?>" ></i></a>
			</td>	
