...
<div class="btn-toolbar" style="margin-bottom:2px;">
    <a href="__APP__/Product/edit/id/<?php echo ($pid); ?>" class="btn btn-primary"><i class="icon-plus"></i>编辑产品(PS:可上传图片哦)</a>
</div>
    <div class="block">
        ...
        <div id="page-stats" class="block-body collapse in">
              ...
              <input type="hidden" id="pro_id" name="product_id" value="<?php echo ($pid); ?>">
              	...
              	<td><?php echo ($PicturetList["name"]); ?></td>
              	<td><?php echo ($PicturetList["select"]); ?></td> 
              	<td><?php echo ($PicturetList["sort_select"]); ?></td>                                         	
              <td>
				<a class="btn" href="__URL__/pic_del/id/<?php echo ($PicturetList["id"]); ?>" title= "删除" >删除</a>
			<input type="submit"  class="btn sub"  value="修改图片名称" pic_id="<?php echo ($PicturetList["id"]); ?>"  pic_name="<?php echo ($PicturetList["name"]); ?>" product_id="<?php echo ($pid); ?>"/>
			</td>	
