    ...
    <div class="block">
        ...
        <div id="page-stats" class="block-body collapse in">
              ...
              <td>
				...
				<br>
				<a href="__APP__/Product/pic_edit/id/<?php echo ($result_list["id"]); ?>" title= "图片" class="btn btn-danger" >图片</a>
				<a href="__APP__/Travel/index/id/<?php echo ($result_list["id"]); ?>" title= "行程" class="btn btn-danger" >行程</a>
				<a href="__APP__/Cost/index/id/<?php echo ($result_list["id"]); ?>" title= "费用" class="btn btn-danger" >费用</a>
